 ...
 */
#if defined CHECK_EXCLS && (CALC_COULOMB || defined LJ_EWALD)
#define EXCL_FORCES
#endif
...
#if CALC_ENERGIES || defined LJ_POT_SWITCH
...
#if CALC_ENERGIES || CALC_ELEC_POTENTIAL
            real coulFuncValue = interact*rinv + k_rf*rsq - c_rf;
            /* 3 flops for RF energy */
#endif
#endif
...
#endif
            fcoul *= qq*rinv;
            /* 1 flop for Coulomb charge factor multiplication */
#endif /* CALC_COUL_TAB */

#if CALC_ENERGIES
            vcoul = qq*coulFuncValue;
            /* 1 flop for Coulomb charge factor multiplication */
#ifdef ENERGY_GROUPS
