...
#if CALC_ENERGIES || GMX_COMPUTE_ELECTROSTATIC_POTENTIAL
...
#ifdef CALC_COUL_TAB
#if CALC_ENERGIES || GMX_COMPUTE_ELECTROSTATIC_POTENTIAL
    const real halfsp = 0.5/ic->tabq_scale;
#endif
...
#if CALC_ENERGIES && defined ENERGY_GROUPS
    int egp_mask = (1 << nbatParams.neg_2log) - 1;
#endif
