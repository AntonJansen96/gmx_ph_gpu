...
#    if (defined CALC_ENERGIES || GMX_COMPUTE_ELECTROSTATIC_POTENTIAL) && !defined TAB_FDV0
...
#if (defined CALC_ENERGIES || GMX_COMPUTE_ELECTROSTATIC_POTENTIAL) \
        && (defined CALC_COUL_EWALD || defined CALC_COUL_TAB)
    SimdReal sh_ewald_S;
#endif
...
#if (defined CALC_COUL_TAB || defined CALC_COUL_EWALD) \
        && (defined CALC_ENERGIES || GMX_COMPUTE_ELECTROSTATIC_POTENTIAL)
