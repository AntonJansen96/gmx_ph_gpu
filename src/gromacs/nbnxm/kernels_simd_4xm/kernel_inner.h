...
#define CALC_ELEC_POTENTIAL  (GMX_COMPUTE_ELECTROSTATIC_POTENTIAL && CALC_COULOMB)
 ...
 * contributions.
 */
#if defined CHECK_EXCLS && (CALC_COULOMB || defined LJ_EWALD_GEOM)
#define EXCL_FORCES
#endif
...
#if (CALC_COULOMB && defined CALC_COUL_TAB) || defined LJ_FORCE_SWITCH || defined LJ_POT_SWITCH
    SimdReal r_S0;
    SimdReal r_S1;
#if (CALC_COULOMB && defined CALC_COUL_TAB) || !defined HALF_LJ
    SimdReal r_S2;
    SimdReal r_S3;
#endif
#endif
...
#if defined CALC_ENERGIES || CALC_ELEC_POTENTIAL
...
#endif
#endif
#if (defined CALC_ENERGIES || CALC_ELEC_POTENTIAL) && (defined CALC_COUL_EWALD || defined CALC_COUL_TAB)
...
#define     rinv_ex_S3    rinv_S3
...
#if defined CALC_ENERGIES || CALC_ELEC_POTENTIAL
    vcoul_S0    = rinv_ex_S0 + fma(rsq_S0, hrc_3_S, moh_rc_S);
    vcoul_S1    = rinv_ex_S1 + fma(rsq_S1, hrc_3_S, moh_rc_S);
    vcoul_S2    = rinv_ex_S2 + fma(rsq_S2, hrc_3_S, moh_rc_S);
    vcoul_S3    = rinv_ex_S3 + fma(rsq_S3, hrc_3_S, moh_rc_S);
#endif
#endif
    ...
    vcoul_S0    = rinv_ex_S0 - vc_sub_S0;
    vcoul_S1    = rinv_ex_S1 - vc_sub_S1;
    vcoul_S2    = rinv_ex_S2 - vc_sub_S2;
    vcoul_S3    = rinv_ex_S3 - vc_sub_S3;

#endif

#if defined CALC_ENERGIES || CALC_ELEC_POTENTIAL
    /* Mask potential value for cut-off and diagonal */
...
#if CALC_ELEC_POTENTIAL
    pot_S0      = pot_S0 + jq_S*vcoul_S0;
    pot_S1      = pot_S1 + jq_S*vcoul_S1;
    pot_S2      = pot_S2 + jq_S*vcoul_S2;
    pot_S3      = pot_S3 + jq_S*vcoul_S3;

    store(pot + aj, load<SimdReal>(pot + aj) + iq_S0*vcoul_S0 + iq_S1*vcoul_S1 + iq_S2*vcoul_S2 + iq_S3*vcoul_S3);
#endif

#if defined CALC_ENERGIES || CALC_ELEC_POTENTIAL
    /* Add charge factors */
    vcoul_S0    = qq_S0 * vcoul_S0;
    vcoul_S1    = qq_S1 * vcoul_S1;
    vcoul_S2    = qq_S2 * vcoul_S2;
    vcoul_S3    = qq_S3 * vcoul_S3;
#endif
