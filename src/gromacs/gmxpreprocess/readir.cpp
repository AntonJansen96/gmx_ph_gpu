            ...
            warninp_t       wi)
{
    ...
    ir->lambda_dynamics   = (get_eeenum(&inp, "lambda-dynamics", yesno_names, wi) != 0);
    ir->eLambdaThermostat = get_eeenum(&inp, "lambda-dynamics-tcoupl", eLambdaTcoupl_names, wi);
    ir->bLambdaChargeConstraints =
            (get_eeenum(&inp, "lambda-dynamics-charge-constraints", yesno_names, wi) != 0);
    ir->bLambdaMultiStateConstraints =
            (get_eeenum(&inp, "lambda-dynamics-multistate-constraints", yesno_names, wi) != 0);
    ir->bLambdaIsCalibration = (get_eeenum(&inp, "lambda-dynamics-calibration", yesno_names, wi) != 0);
