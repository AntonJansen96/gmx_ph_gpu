...
enum tpxv
{
    ...
    tpxv_ConstantpH,                              /**< Added constant pH stuff */
...
static void do_inputrec(gmx::ISerializer* serializer, t_inputrec* ir, int file_version)
{
    ...
    if (file_version >= tpxv_ConstantpH)
    {
        ...
        serializer->doBool(&ir->bLambdaChargeConstraints);
        serializer->doBool(&ir->bLambdaMultiStateConstraints);
        serializer->doBool(&ir->bLambdaIsCalibration);
        serializer->doInt(&ir->eLambdaThermostat);
    }
